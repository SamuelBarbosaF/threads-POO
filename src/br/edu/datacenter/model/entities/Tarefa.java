...
public class Tarefa {
    ...
    private long tempoExecucaoRestante; // em milissegundos
    ...
    public Tarefa(int id, long tempoExecucao, int prioridade, List<Integer> idsDependencias) {
        ...
        this.idsDependencias = new ArrayList<>(idsDependencias); // Cópia defensiva para POO
    }
    ...
    // Boa prática de POO: retornar uma nova lista para ninguém alterar a lista interna de fora da classe
